...
def scanfolder():
    for path, dirs, files in os.walk('/home/ravindra/Rinkle-bands-without_with-soc-primitive'):
        #print path
        #print dirs
        #print files
        for _dir in dirs:
        	os.chdir(path+"/"+_dir)
        	if os.path.isfile('vasprun.xml') & os.path.isfile('band') :
        		os.system('cp /home/ravindra/Rinkle-bands-without_with-soc-primitive/bandplotting-orb-resolved-bug-removed-without-borders.py .' )
        		cwdir1 = os.getcwd().replace("/","/")
        		#print path
        		#print path + cwdir1[71:]
        		cwdir2 = os.getcwd().replace("/","-")
        		#print cwdir2[55:]
        		os.system("time python bandplotting-orb-resolved-bug-removed-without-borders.py " + cwdir2[55:])
