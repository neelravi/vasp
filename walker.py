...
def scanfolder():
    for path, dirs, files in os.walk('/home/ravindra/'):
        print path
        print dirs
        print files
        #for _dir in dirs:
        #	os.chdir(path+"/"+_dir)
        #	if os.path.isfile('vasprun.xml') & os.path.isfile('vasprun.xml') :
        ...
        #		print "Plotting figure in   " + path + cwdir[31:]
        #		os.system("time python bandplotting-orb-resolved-bug-removed-without-borders.py " + cwdir[31:])
